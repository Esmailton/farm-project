...
urlpatterns = [
    ...
    path('department/list/', department.DepartmentListView.as_view(), name='department_list'),
    path('department/create/', department.DepartmentCreateView.as_view(), name='department_create'),
    path('department/<uuid:pk>/update/', department.DepartmentUpdateView.as_view(), name='department_update'),
    path('department/<uuid:pk>/delete/', department.DepartmentDeleteView.as_view(), name='department_delete'),
    path('department/<uuid:pk>/detail/', department.DepartmentDetailView.as_view(), name='department_detail'),
]