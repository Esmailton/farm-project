...
class PersonModelTest(TestCase):
    ...
    def test_person_get_absolute_url(self):
        self.assertEqual(
            f"/person/{self.person.id}/detail/", self.person.get_absolute_url()
        )
...
class PhoneModelTest(TestCase):
    ...
    def test_phone_representation(self):
        self.assertEqual(str(self.phone), self.phone.phone)

    def test_phone_get_absolute_url(self):
        self.assertEqual(
            f"/phone/{self.phone.id}/detail/", self.phone.get_absolute_url()
        )
...
class EmailModelTest(TestCase):
    ...
    def test_email_get_absolute_url(self):
        self.assertEqual(
            f"/email/{self.email.pk}/detail/", self.email.get_absolute_url()
        )
